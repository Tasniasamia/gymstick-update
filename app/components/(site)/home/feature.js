    ...
    <div className="mb-[120px]">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-4 gap-[24px]">
          <div
            className="px-[26px] py-[48px] rounded-[4px] text-textcolor border  group bg-white hover:bg-primary hover:text-white duration-150 transition-all flex flex-col items-center"
            style={{ boxShadow: "0px 0px 20px 0px rgba(0, 0, 0, 0.10)" }}
          >
            <div
              className="w-[56px] h-[56px] flex justify-center items-center bg-white rounded-full"
          ...
          <div
            className="px-[26px] py-[48px] rounded-[4px] text-textcolor  group bg-white hover:bg-primary hover:text-white duration-150 transition-all flex flex-col items-center"
            style={{ boxShadow: "0px 0px 20px 0px rgba(0, 0, 0, 0.10)" }}
          >
            <div
              className="w-[56px] h-[56px] flex justify-center items-center bg-white rounded-full"
